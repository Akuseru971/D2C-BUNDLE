...
- Upload up to thirteen product images (any slot) and optional logo
...
2. Optionally add more products, a **Logo**, and toggle **Détourage** to remove white backgrounds automatically.
